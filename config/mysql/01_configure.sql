...
-- Create connection
INSERT INTO guacamole_connection (connection_name, protocol) VALUES ('Windows Server (ad)', 'rdp');
INSERT INTO guacamole_connection (connection_name, protocol) VALUES ('Database Server (db)', 'ssh');
INSERT INTO guacamole_connection (connection_name, protocol) VALUES ('OUD Server (oud)', 'ssh');
...
INSERT INTO guacamole_connection_parameter VALUES (2, 'private-key', 'PRIVATEKEY');
...
INSERT INTO guacamole_connection_parameter VALUES (3, 'private-key', 'PRIVATEKEY');